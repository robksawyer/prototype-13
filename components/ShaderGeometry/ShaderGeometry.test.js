...
describe('components', () => {
  describe('ShaderGeometry', () => {
    it('should mount with props', function () {
      const wrap = mount(<ShaderGeometry>Hello World</ShaderGeometry>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<ShaderGeometry>Hello World</ShaderGeometry>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('shader_geometry')
