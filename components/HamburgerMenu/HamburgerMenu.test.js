...
describe('components', () => {
  describe('HamburgerMenu', () => {
    it('should mount with props', function () {
      const wrap = mount(<HamburgerMenu>Hello World</HamburgerMenu>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<HamburgerMenu>Hello World</HamburgerMenu>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('hamburger_menu')
